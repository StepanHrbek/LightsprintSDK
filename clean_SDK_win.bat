...
if ERRORLEVEL 1 goto error
devenv src\RR.vs2010.sln /clean "Debug DLL|Win32" >nul
if ERRORLEVEL 1 goto error
devenv src\RR.vs2010.sln /clean "Release DLL|Win32" >nul
if ERRORLEVEL 1 goto error
devenv src\RR.vs2010.sln /clean "Debug DLL|x64" >nul
if ERRORLEVEL 1 goto error
devenv src\RR.vs2010.sln /clean "Release DLL|x64" >nul
if ERRORLEVEL 1 goto error
