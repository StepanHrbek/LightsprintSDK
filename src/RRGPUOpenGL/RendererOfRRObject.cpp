...
void RendererOfRRObject::render()
{
	...
	bool indexedYesNeeded = 
		params.renderedChannels.LIGHT_INDIRECT_VCOLOR; // buffer generated by RRRealtimeRadiosity for original (preimport) vertex order
	...
	bool nonBufferedNeeded =
		...
		(params.renderedChannels.LIGHT_INDIRECT_VCOLOR || params.renderedChannels.LIGHT_INDIRECT_MAP);
