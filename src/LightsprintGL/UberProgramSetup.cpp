...
//
// UberProgramSetup, settings specific for our UberProgram.vs/fs.
// --------------------------------------------------------------------------
...
private:
	typedef std::unordered_map<unsigned,rr::RRBuffer*> Buffer1x1Cache;
...
const char* UberProgramSetup::getSetupString()
{
	...
	sprintf(setup,"%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s",
		...
		LIGHT_INDIRECT_VCOLOR_LINEAR?"#define LIGHT_INDIRECT_VCOLOR_LINEAR\n":"",
...
void UberProgramSetup::validate()
{
	...
	if (!incomingLight || !reflectsLight)
	{
		...
		LIGHT_INDIRECT_VCOLOR2 = 0;
		LIGHT_INDIRECT_VCOLOR_LINEAR = 0;
