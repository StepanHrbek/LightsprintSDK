...
int main(int argc, char **argv)
{
 ...
 rrCollider::registerLicense(
	 ...
	 "DDMKFCKHMCEOFNAIGHIEFBKMMCGEDAEHEJNNNPELIBHDLKMHFA"
	 "CABOJJGOIHDIMFFDPEGGMFBFIMEHIPMGACJILAHFDGPEBGOIGN"
	 "NMDDBFNBCJFCFPKGNBBMCGBOLIOANEKCEHJEIGKGECGFLNOFFD"
	 "DAPFABJPCOLCOBFBACOLLNOLDCKICHMMCHOJHBGGOOLGFJIOFI"
	 "ACHAKOOCFDPFMCFGEBOIMMEBLJOJDPPFDMMJIPOLFPDLPHFIMM"
	 "EELGAPKGMH");
