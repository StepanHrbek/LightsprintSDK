...
SVFrame::SVFrame(wxWindow* _parent, const wxString& _title, const wxPoint& _pos, const wxSize& _size, SceneViewerStateEx& _svs)
	: wxFrame(_parent, wxID_ANY, _title, _pos, _size, wxDEFAULT_FRAME_STYLE|wxMINIMIZE), svs(_svs), smoothDlg(this), deleteDlg(this), bakeDlg(this), unwrapDlg(this), importDlg(this)
{
	fullyInited = false;
