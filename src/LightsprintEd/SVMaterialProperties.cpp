...
void SVMaterialProperties::OnPropertyChange(wxPropertyGridEvent& event)
{
	...
	if (property==propDiffuse->GetPropertyByName(_("texture or video")))
	{
		...
		material->diffuseReflectance.updateColorFromTexture(NULL,false,false,rr::RRMaterial::UTA_KEEP,false);
	...
	if (property==propSpecular->GetPropertyByName(_("texture or video")))
	{
		...
		material->specularReflectance.updateColorFromTexture(NULL,false,false,rr::RRMaterial::UTA_KEEP,false);
	...
	if (property==propEmissive->GetPropertyByName(_("texture or video")))
	{
		...
		material->diffuseEmittance.updateColorFromTexture(NULL,true,false,rr::RRMaterial::UTA_KEEP,false);
	...
	if (property==propTransparent->GetPropertyByName(_("texture or video")))
	{
		...
		material->specularTransmittance.updateColorFromTexture(NULL,false,material->specularTransmittanceInAlpha,rr::RRMaterial::UTA_KEEP,false);
