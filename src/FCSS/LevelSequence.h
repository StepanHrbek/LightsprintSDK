...
public:
	LevelSequence()
	{
		...
		insertLevelBack("bsp\\bgmp\\maps\\bgmp6.bsp");               // ++pekne drevo, int, chybi malinko textur
		insertLevelBack("bsp\\x3map\\maps\\x3map05.bsp");            // ++ext, originalni geometrie levelu
		insertLevelBack("bsp\\bastir\\maps\\bastir.bsp");            // ++pekny bunkr na snehu, int i ext, jen snih neni sesmoothovany, chybi malinko textur
		insertLevelBack("bsp\\bgmp\\maps\\bgmp8.bsp");               // ++pekne skaly a odrazy od zelene travy, int i ext, chybi malinko textur
		insertLevelBack("3ds\\Trajectory\\Trajectory.3ds");          //  +original geometrie
		insertLevelBack("bsp\\trajectory\\maps\\trajectory.bsp");    //  +original geometrie
