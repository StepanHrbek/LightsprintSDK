...
/* $Id: //sw/main/apps/OpenGL/mjk/shadowcast/nvidia_logo.c#3 $ */
...
GLfloat greenColor[] = {0.611, 0.807, 0.0, 1.0};
GLfloat grayColor[] = {0.666, 0.666, 0.666, 1.0};
...
makeNVidiaLogo(GLuint dlistBase)
{
  ...
  setAmbientAndDiffuseMaterial(greenColor);
  glCallList(dlistBase+3);
  glCallList(dlistBase+6);
  setAmbientAndDiffuseMaterial(grayColor);
