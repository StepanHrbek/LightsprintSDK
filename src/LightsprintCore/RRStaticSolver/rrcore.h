...
public:
	...
	RRVec3  getPointMeasure(RRRadiometricMeasure measure, const RRVec2& uv) const; // supports only RM_IRRADIANCE_PHYSICAL, RM_IRRADIANCE_PHYSICAL_DIRECT, RM_IRRADIANCE_LINEAR_INDIRECT
