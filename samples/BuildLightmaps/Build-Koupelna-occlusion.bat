...
BuildLightmaps.bat ../../data/scenes/koupelna/koupelna4-windows.dae viewer occlusion "outputpath=../../data/export/koupelna" "quality=1000" "mapsize=0" object:0 "mapsize=256"