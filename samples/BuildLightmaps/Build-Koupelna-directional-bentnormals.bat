...
BuildLightmaps.bat ../../data/scenes/koupelna/koupelna4-windows.dae directional bentnormals viewer "quality=500" "outputpath=../../data/export/koupelna" "mapsize=0" object:0 "mapsize=256"