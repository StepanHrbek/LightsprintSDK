...
//#define LIGHTMAPS // Makes indirect illumination stored into and rendered from lightmaps (instead of vertex buffers).
...
protected:
	...
	{
		// decide how big lightmap you want for object
