...
//#define LIGHTMAPS
// Makes indirect illumination stored into and rendered from lightmaps (instead of vertex buffers).
// With lightmaps render is slower:
// - generating lightmaps is more expensive than generating vertex buffer
...
#ifndef LIGHTMAPS
	// m3ds.Draw uses tristrips -> fast but can't be used with added lightmap unwrap
...
#endif
	// RendererOfRRObject::render uses trilist -> slow, but no problem with added lightmap unwrap
...
protected:
	...
	{
		// decide how big lightmap you want for object. increase when edges appear
...
void display(void)
{
	...
	if(!solver->getIllumination(0)->getChannel(0)->pixelBuffer) // if lightmaps don't exist yet, create them
	{
