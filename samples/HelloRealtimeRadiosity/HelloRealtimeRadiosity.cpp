...
// called at each key repeat generated by operating system (eg 33hz)
// fights with screen refresh (eg 60hz),
// when you move by keys, screen looks like 10hz even if it's 60!
// used only for simplicity, replace with your engine smooth inputs
