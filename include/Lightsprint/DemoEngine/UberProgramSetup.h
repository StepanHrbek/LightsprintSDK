...
struct DE_API UberProgramSetup
{
	...
	//! that may be processed in one pass using given setup (material & lighting).
	static unsigned detectMaxShadowmaps(UberProgram* uberProgram, UberProgramSetup uberProgramSetup);
