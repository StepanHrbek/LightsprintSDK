...
public:
	...
	//PluginParamsStereo(const PluginParams* _next, StereoMode _stereoMode, bool _stereoSwap) : stereoMode(_stereoMode), stereoSwap(_stereoSwap), oculusDistortionK(1,0.22f,0.24f,0), oculusChromaAbCorrection(0.996f,-0.004f,1.014f,0), oculusLensShift(0.152f), oculusTanHalfFov(nullptr) {next=_next;}
