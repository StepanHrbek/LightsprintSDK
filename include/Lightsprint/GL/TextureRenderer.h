...
public:
	...
	bool renderEnvironment(const Texture* texture, float color[4], float gamma);
	...
	bool renderEnvironmentBegin(float color[4], bool allowDepthTest, bool physical, float gamma);
