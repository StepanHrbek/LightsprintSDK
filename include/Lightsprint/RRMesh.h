...
//
//! \file RRMesh.h
//! \brief LightsprintCore | 3d triangle mesh interface
//----------------------------------------------------------------------------
...
namespace rr
{
	...
	public:
		...
		//!  RRMaterial::lightmap.texcoord for unwrap used by lightmaps etc.
		...
		//!  Optional lightmap texcoord channel (it is stored in RRMaterial::lightmap.texcoord).
	...
	public:
		...
		//! It is filled by buildUnwrap(), but it is currently not used, renderer and solver use RRMaterial::lightmap.texcoord instead.
