...
namespace rr
{
	...
	public:
		...
		//!  If it's NULL, pixel buffer generated by RRObjectIllumination::newPixelBuffer
		//!  and stored in RRRealtimeRadiosity::getIllumination()->getChannel(0)->pixelBuffer
		//!  is used.
		void updateAmbientMap(unsigned objectNumber, RRIlluminationPixelBuffer* customPixelBuffer=NULL);
