				...
				vec4(( 
						...
						+ (
							...
							+ dividedByAlpha(texture2DLod(lightIndirectMirrorMap, mirrorCenter, 6.0)
								// mipmaps generated by GPU are terrible; if we don't add fallback to perfect mirror, large areas could reflect 0/0=undefined
								// how serious this problem is depends on viewport resolutions
								+mirrorFallback)
						#endif
					#ifdef LIGHT_INDIRECT_DETAIL_MAP
